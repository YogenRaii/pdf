...
INSERT INTO questionType (`id`,`name`,`description`) values (4,"Javascript","Despite some naming, syntactic, and standard library similarities, JavaScript and Java are otherwise unrelated and have very different semantics. ")
...
INSERT INTO `user` (`id`, `username`, `password`, `email`,`dateCreated`, `role`,`profile_id`) VALUES (2,'rabi','rabi','rabi@gmail.com','2015-10-15 22:14:54','general',2);
...
INSERT INTO `user` (`id`, `username`, `password`, `email`,`dateCreated`, `role`,`profile_id`) VALUES (3,'rockie','rockie','rockie92@gmail.com','2015-10-16 22:14:54','general',3);
...
INSERT INTO `user` (`id`, `username`, `password`, `email`,`dateCreated`, `role`,`profile_id`) VALUES (4,'rita','rita','khaling.rita.92@gmail.com','2015-10-12 22:14:54','admin',4);
...
INSERT INTO `user` (`id`, `username`, `password`, `email`,`dateCreated`, `role`,`profile_id`) VALUES (5,'manish','manish','manish@gmail.com','2015-10-13 22:14:54','general',5);

INSERT INTO `profile`(`id`, `address`, `dateOfBirth`, `firstName`, `gender`, `lastName`, `occupation`) VALUES (6,"NULL",'1992-11-15 22:14:54',"NULL","M","NULL","NULL")
INSERT INTO `user` (`id`, `username`, `password`, `email`,`dateCreated`, `role`,`profile_id`) VALUES (6,'usha','usha','usha@gmail.com','2015-10-10 22:14:54','admin',6);
...
INSERT INTO `question`(`id`, `dateCreated`, `heading`, `questionContent`, `questionType_id`, `user_id`) VALUES (2,"2015-10-17 22:14:54","Eliminate The Need For Casting","I am busy writing an API which modifies a graph. To control what I am exposing to the users of the API I am using interfaces. The interfaces exposing the methods which will be used are as follows. ",3,2)

INSERT INTO `question`(`id`, `dateCreated`, `heading`, `questionContent`, `questionType_id`, `user_id`) VALUES (3,"2015-8-15 22:14:54","Swapping two rows in a matrix","I am having a problem in swapping two rows in a matrix that is a 2D-dynamic array. I wanted to know if there is a function to use directly or if there is none I would like to know how to make one. Thanks in advance.",2,1);
INSERT INTO `question`(`id`, `dateCreated`, `heading`, `questionContent`, `questionType_id`, `user_id`) VALUES (4,"2015-10-18 22:14:54","Exception thrown when serializing Hibernate object to JSON","Well I am using Hibernate to load a tiny database to some classes representing the tables and interact with the database. All fine, and I can really see all results... And I don't have any null field, all of them are been used.",4,1);
